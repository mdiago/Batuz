...
namespace Batuz.TicketBai.Xades.Hash
{

    /// <summary>
    /// SHA256
    /// </summary>
    public class DigestMethodSHA256 : SHA256Managed, IDigestMethod
    {
        ...
        /// </summary>
        readonly string _DigestAlgorithmUrl = "http://www.w3.org/2001/04/xmlenc#sha256";
        ...
        /// del elemento signature.
        /// </summary>
        public string DigestAlgorithmUrl
        {
            get
            {
                return _DigestAlgorithmUrl;
            }
        }
