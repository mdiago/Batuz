...
namespace Batuz.TicketBai.Xades.Xml.Signature
{
    ...
    /// <summary>
    /// Propiedades del objetofirmado.
    /// </summary>
    [Serializable()]
    [XmlType(AnonymousType = true, Namespace = "http://uri.etsi.org/01903/v1.3.2#")]
    public class QualifyingPropertiesSignedPropertiesSignedDataObjectProperties : XmlElementBase
    {
        ...
        /// Propiedades del objetofirmado.
        /// </summary>
        public QualifyingPropertiesSignedPropertiesSignedDataObjectPropertiesDataObjectFormat DataObjectFormat { get; set; }
