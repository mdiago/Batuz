...
namespace Batuz.TicketBai.Xades.Xml.Signature
{
    ...
    /// <summary>
    /// Ufi del calificador de firma.
    /// </summary>
    [Serializable()]
    [XmlType(AnonymousType = true, Namespace = "http://uri.etsi.org/01903/v1.3.2#")]
    public class QualifyingPropertiesSignedPropertiesSignedSignaturePropertiesSignaturePolicyIdentifierSignaturePolicyIdSigPolicyQualifiersSigPolicyQualifier 
    {
