...
namespace Batuz.TicketBai
{
    ...
    public class HuellaTBAI
    {
        ...
        /// </summary>
        public HuellaTBAIEncadenamientoFacturaAnterior EncadenamientoFacturaAnterior { get; set; }

        /// <summary>
        /// Datos del software con el que se emite 
        /// factura/justificante.
        /// </summary>
        public HuellaTBAISoftware Software { get; set; }
