...
namespace Batuz.TicketBai
{
    ...
    public class FacturaTipoDesgloseDesgloseFacturaSujetaNoExentaDetalleNoExenta
    {
        ...
        /// </summary>
        public TipoNoExenta TipoNoExenta { get; set; }

        /// <summary>
        /// DetalleIVA (1 a 6, una agrupación de datos por tipo).
        /// </summary>
        [XmlArrayItem("DetalleIVA", IsNullable = false)]
        public FacturaTipoDesgloseDesgloseFacturaSujetaNoExentaDetalleNoExentaDetalleIVA[] DesgloseIVA { get; set; }
