...
namespace Batuz.Negocio.Configuracion
{
    ...
    /// <summary>
    /// Parámetros de almacenamiento de la aplicación.
    /// </summary>
    public class ParametrosAlmacen
    {

        #region Propiedades Públicas de Instancia

        /// <summary>
        /// Ruta de almacenamiento de la aplicación.
        /// </summary>
        public string RutaAlmacenamiento { get; set; }

        /// <summary>
        /// Ruta de almacenamiento archivos temporales de la aplicación.
        /// </summary>
        public string RutaArchivosTemporales { get; set; }
