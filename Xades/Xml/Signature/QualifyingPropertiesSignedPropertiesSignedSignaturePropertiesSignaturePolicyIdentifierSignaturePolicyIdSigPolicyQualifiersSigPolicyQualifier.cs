...
namespace Xades.Xml.Signature
{
    ...
    public class QualifyingPropertiesSignedPropertiesSignedSignaturePropertiesSignaturePolicyIdentifierSignaturePolicyIdSigPolicyQualifiersSigPolicyQualifier : XmlElementBase
    {

        public string SPURI { get; set; }
